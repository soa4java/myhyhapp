...
import com.roger.quickviewpage.photoview.PhotoViewAttacher.OnPhotoTapListener;
/**
...
public class ImageDetailFragment extends Fragment {
	...
	private ImageDetailFragment _this = this;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(R.layout.activity_image_dialog_item,
				container, false);
		...
		mImageView.setOnPhotoTapListener( new OnPhotoTapListener() {
			...
			public void onPhotoTap(View view, float x, float y) {
				((ImageDetailActivity)(_this.getActivity())).closeActivity();
			}
		});
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (ImageDetailActivity.class.isInstance(getActivity())) {
			...
			mImageWorker.loadBitmap(ImageDetailActivity.imageUrls[mImageNum], mImageView,new OnImageLoadedListener() {
