...
public class XmppConnectionManager {
	...
	public XMPPConnection init() {
		...
		configure(pm);
		connectionConfig = new ConnectionConfiguration( Conf.host, Conf.port );
		...
		GezitechApplication.connection = connection;
		return connection;
	}
	//xmpp登录
	public void login(){
		if( GezitechApplication.isConnection > 0 ) 
			return;
		disconnect();
		init();
		LoginTask loginTask = new LoginTask( GezitechApplication.getContext() );
		loginTask.execute();
	}
	/**
	 * 
